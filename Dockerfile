...
## clean
RUN rm -rf /tmp/ckb_v0.33.1_x86_64-unknown-linux-gnu /tmp/goreman /tmp/dumb-init.deb
RUN apt-get -y remove unzip wget software-properties-common && apt-get -y autoremove && apt-get clean
